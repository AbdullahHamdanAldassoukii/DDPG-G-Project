...
class ActorNetwork:
	...
	def __init__(self,sess,state_dim,action_dim):
		...
		self.update_target()
		#self.load_network()
		print("finished init actor network !")
	...
	def load_network(self,eps):
		self.saver = tf.train.Saver()
		checkpoint = tf.train.get_checkpoint_state("./weights/actor-weights"+str(eps))
	...
	def save_network(self,n):
		self.saver2 = tf.train.Saver()
		print('save actor-network...')
		self.saver2.save(self.sess, './weights/actor-weights'+str(n)+'/actor-weights')
